...
var calSpanID = "calBorder"; // span IDcalSpanID
...
var EndYear = (2037 - new Date().getFullYear()); // The last year of pickable date. if current year is 2011, the last year that still picker will be 2016 (2011+5)
...
var imageFilesPath = "/images/calendar_datetime/";
//Configurable parameters end

//end Configurable parameters

var pdgExImages = ["<span onmousedown='javascript:Cal.DecMonth();RenderCssCal();' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' class='fa fa-caret-square-o-left' style='margin-right:2px;'>&nbsp;</span>",
    "<span onmousedown='javascript:Cal.IncMonth();RenderCssCal();' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' class='fa fa-caret-square-o-right' style='margin-left:2px;'>&nbsp;</span>",
    "<span onmousedown='javascript:Cal.DecYear();RenderCssCal();' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' class='fa fa-backward'>&nbsp;</span>",
    "<span onmousedown='javascript:Cal.IncYear();RenderCssCal();' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' class='fa fa-forward'>&nbsp;</span>",
    "<span onclick='nextStep(\"Hour\", \"plus\");' onmousedown='startSpin(\"Hour\", \"plus\");' onmouseup='stopSpin();' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' class='fa fa-caret-up'>&nbsp;</span>",
    "<span onclick='nextStep(\"Hour\", \"minus\");' onmousedown='startSpin(\"Hour\", \"minus\");' onmouseup='stopSpin();' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' class='fa fa-caret-down'>&nbsp;</span>",
    "<span onclick='nextStep(\"Minute\", \"plus\");' onmousedown='startSpin(\"Minute\", \"plus\");' onmouseup='stopSpin();' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' class='fa fa-caret-up'>&nbsp;</span>",
    "<span onmousedown='startSpin(\"Minute\", \"minus\");' onmouseup='stopSpin();' onclick='nextStep(\"Minute\",\"minus\");' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' class='fa fa-caret-down'>&nbsp;</span>",
];
...
function RenderCssCal(bNewCal)
{
	...
	if (Cal.Scroller === "DROPDOWN") {
        if (ShowLongMonth) {
            visibleMonth = ShowLongMonth;
        }
	    vCalHeader += "<td align='center'>"
            +pdgExImages[0] // Decrease Month
            +"<select name='MonthSelector' onChange='javascript:Cal.SwitchMth(this.selectedIndex);RenderCssCal();'>";
		for (i = 0; i < 12; i += 1) {
			if (i === Cal.Month) {
				SelectStr = "Selected";
			} else {
			...
			vCalHeader += "<option " + SelectStr + " value=" + i + ">" 
                +((ShowLongMonth) ? MonthName[i] : MonthName[i].substr(0, 3))
                + "</option>";
		}
		vCalHeader += "</select>"
            +pdgExImages[1] // Decrease Month
            +"</td>";
		//Year selector
		vCalHeader += "<td align='center'>"
            +pdgExImages[2] // Decrease Year
            +"<select name='YearSelector' size='1' onChange='javascript:Cal.SwitchYear(this.value);RenderCssCal();'>";
	...
	//******************Month and Year selector in arrow*********************************
		...
		if (UseImageFiles) {
			vCalHeader += "<td>"+pdgExImages[2]+"</td>\n";//Year scroller (decrease 1 year)
			vCalHeader += "<td>"+pdgExImages[0]+"</td>\n"; //Month scroller (decrease 1 month)
			vCalHeader += "<td width='70%' class='calR' style='color:"+YrSelColor+"'>"+ Cal.GetMonthName(ShowLongMonth) + " " + Cal.Year + "</td>"; //Month and Year
			vCalHeader += "<td>"+pdgExImages[1]+"</td>\n"; //Month scroller (increase 1 month)
			vCalHeader += "<td>"+pdgExImages[3]+"</td>\n"; //Year scroller (increase 1 year)
			calHeight += 22;
		} else {
	...
	if (Cal.ShowTime === true) {
		...
		if (ShowArrows && UseImageFiles) { //this is where the up and down arrow control the hour.
		    vCalTime += "<td style='vertical-align:middle;'><table cellspacing='0' cellpadding='0' style='line-height:0pt;width:100%;'><tr><td style='text-align:center;'>"
                +pdgExImages[4]
		...
		vCalTime += "</td><td style='font-weight:bold;text-align:center;'>";
		if (ShowArrows && UseImageFiles) { //this is where the up and down arrow to change the "Minute".
		    vCalTime += "<table cellspacing='0' cellpadding='0' style='line-height:0pt;width:100%'><tr><td style='text-align:center;'>"
                    +pdgExImages[6]
                    +"</td></tr><tr><td style='text-align:center;'>"
                    +pdgExImages[7]
                    +"</td></tr></table>";
	    ...
	    //close button
	    if (UseImageFiles) {
	        vCalClosing += "<span onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' class='fa fa-close'>&nbsp;</span></td>";
	    } else {
